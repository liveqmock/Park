        ...
        <el-col :span="24" class="main">
            <aside :class="collapsed?'menu-collapsed':'menu-expanded'" style="overflow-y: auto;margin-left: 12px">
                ...
                <el-menu class="el-menu-vertical-demo not-print" @open="handleopen"
                    ...
                    <el-row v-show="park">
                        <el-submenu v-if="GasStationManage" index="/orderManage">
                            <template slot="title"><span class="menuitem">加油站管理</span></template>
                            <el-menu-item index="/GasStationManage_Message" v-if="MessageManage">信息管理
                            </el-menu-item>
                            <el-menu-item index="/GasStationManage_Logs" v-if="LogsManage">日志管理
                            </el-menu-item>
                            <el-menu-item index="/GasStationManage_Connection" v-if="ConnectionsManage">连接管理
                            </el-menu-item>
                        </el-submenu>
