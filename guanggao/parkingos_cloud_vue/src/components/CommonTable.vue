        ...
        <el-row style="margin-bottom:8px" v-if="!hideTool">
            <el-col :span="24" align="left">
                <el-col :span="21" align="left">
                    ...
                    <el-button type="primary"  @click="addAdvertiser" v-if="showAdvertiser">添加广告</el-button>
        ...
        <el-dialog
            ...
            <el-form  label-width="120px" style="margin-bottom:-30px">
                <el-form-item label="广告描述" >
                    <el-input v-model="adv_d"  style="width:90%"></el-input>
                </el-form-item>
                <el-form-item label="跳转URL">
                    <el-input v-model="adv_url" style="width:90%"></el-input>
                </el-form-item>
            ...
            <span slot="footer" class="dialog-footer">
				...
				<el-button type="primary" size="small" @click="uploadAdv">保存</el-button>
			</span>
        </el-dialog>
    </section>
</template>
...
<script>
    ...
    export default {
        ...
        props: ['showAdvertiser','tableitems', 'fieldsstr', 'hideOptions', 'hideExport', 'hideAdd', 'showCustomizeAdd', 'showCustomizeEdit', 'hideSearch', 'showLeftTitle', 'leftTitle', 'editFormRules', 'addFormRules',
        ...
        methods: {
            ...
            uploadAdv(){
            	 let vm = this;
		          ...
		          let file = this.file;
		          let description = this.adv_d;
		          let redirectURL=this.adv_url;
		          let u = sessionStorage.getItem('user');
		          let user = JSON.parse(u);
		          
		          param.append('file',file,file.name);//通过append向form对象添加数据
		          param.append('description',description);//
		          param.append('redirectURL',redirectURL);//
		          ...
		          vm.$axios.post(path+'/advertiser/upload', param, {
                            headers:{'Content-Type':'multipart/form-data'}
                       }).then(function (response) {
                            let ret = response.data;
                            if (ret.validate != 'undefined' && ret.validate == '1') {
		          ...
		          /*this.$axios.post(path+'/advertiser/upload',param, config
		            ).then((res)=>{
		            	alert(1111);
		          ...
		          /*this.$axios.post(path+'/advertiser/upload',param,config).then(response=>{
		           	alert(111);
		          })	*/	   
		          
		          /*this.$axios.post(path + '/advertiser/upload', param, {
                            headers: {
