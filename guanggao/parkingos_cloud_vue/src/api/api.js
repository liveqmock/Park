//export const path = 'http://120.25.121.204:8080/cloud';
 ...
 //export const path = "http://192.168.1.156:8082"
// export const path = 'http://192.168.199.205:12305';
export const path = "http://47.104.81.226:8888/zld"
...
export const openType = [
    {'value_no': 0, 'value_name': '否'},
    {'value_no': 1, 'value_name': '是'}
];
export const sendState = [
    {'value_no': 0, 'value_name': '失败'},
    {'value_no': 1, 'value_name': '成功'}
];
export const sdkState = [
    {'value_no': 0, 'value_name': '未处理'},
    {'value_no': 1, 'value_name': '已处理'}
];
