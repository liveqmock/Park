		...
		<div align="center" style="padding-top:15px">
			<div style="padding:5px;height:45px;padding-top:8px;border-radius:4px;background:white;">
				<form method="get" role="form" action="${furl}" id="checkform">
					...
					<input readonly style="vertical-align:middle;border:0px solid;width:55px;text-decoration: none;font-size:17px" value="车牌号">
		    	...
		    	<div style="display:inline;" v-for="letter3 in letters3">
					<mt-button :style="letter1Style" @click="handleClick(letter3.name)">
						<div v-if="letter3.name=='DEL'">
							<img src="${pageContext.request.contextPath}/images/wxpublic/back.png" style="margin-top:4px" height="15" width="22" slot="icon">
						</div>
						<div v-if="letter3.name!='DEL'">
						{{letter3.name}}
						</div>
